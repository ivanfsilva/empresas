package br.com.ivanfsilva.empresas.repository;

import br.com.ivanfsilva.empresas.model.Empresa;
import br.com.ivanfsilva.empresas.model.RamoAtividade;
import br.com.ivanfsilva.empresas.model.TipoEmpresa;
...
public class CamadaPersistencia {
    ...
    public static void main(String[] args) {
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("EmpresasPU");
